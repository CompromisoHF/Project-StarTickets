...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "5hcwP2KfP7r7BxrVpXn1ymO7LiCUiRxI";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
		    ...
		    //get input stream from TM
		    BufferedReader reader = new BufferedReader(new InputStreamReader(connection.getInputStream()));//call TM API
		    String line;
		    StringBuilder builder = new StringBuilder();
		    while ((line = reader.readLine())!= null) {   //append all stream pieces
				builder.append(line);
			}
		    reader.close();
